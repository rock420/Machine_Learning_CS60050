    ...
    def build_tree(self,training,features,max_tree_depth=4,value=None,l=0):
        ...
        for i in features:
            ...
            if(ig>max_gain):
                ...
                splitting_attr=i
        branches=[]
        for v in np.unique(training[:,self.attribute[splitting_attr]]):
            if(training[training[:,self.attribute[splitting_attr]]==v].size==0): 
                 ...
                 branches.append(self.build_tree(training[training[:,self.attribute[splitting_attr]]==v],features[features!=splitting_attr],
